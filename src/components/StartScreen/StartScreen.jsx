...
const StartScreen = ({ magic }) => {
  const animationProps = useSpring({ x: 100, from: { x: 0 } });
  ...
  return (
    ...
    >
      <animated.svg className="start-screen__logo" strokeDashoffset={animationProps.x}>
        <path
      ...
      <div className="start-screen__content">
        <Typist cursor={{ show: false }}>
          ...
          <p className="start-screen__text">Awesome, just try it</p>
        </Typist>
      </div>
